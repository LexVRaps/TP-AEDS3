...
public class MenuPassagens {
   ...
   public void menu() {
    ...
    public void incluir() {
    System.out.println("\nInclusão de Passagem (Horário e Rota devem estar associados)");
    ...
    try {
        ...
        Passagem passagem = new Passagem(dataViagem, preco, rotaId, horarioId, assentoId);
        int id = arqPassagens.create(passagem, rotaId, horarioId, assentoId);
   ...
   public void excluir() {
    ...
    String emailUsuario = console.nextLine();
    ...
    try {
        Usuario usuario = arqUsuarios.read(emailUsuario);
        if (usuario == null) {
 ...
 public void listarPassagensDoUsuario() {
    ...
    public void desassociarUsuario() {
        ...
        try {
            Usuario usuario = arqUsuarios.read(emailUsuario);
            if (usuario == null) {
                System.out.println("Erro: Usuário '" + emailUsuario + "' não encontrado!");
                return;
            }
