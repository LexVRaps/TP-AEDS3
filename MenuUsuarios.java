...
public class MenuUsuarios {
    ...
    public void menu() {
        ...
        do {
            ...
            System.out.println("5 - Listar passagens de um usuário");
    ...
    private void alterarUsuario() {
        System.out.println("\nALTERAR USUÁRIO");
        System.out.print("Email do usuário a ser alterado: ");
        String emailBusca = console.nextLine();

        try {
            Usuario usuarioExistente = arqUsuarios.read(emailBusca);
            if (usuarioExistente != null) {
                ...
                if (arqUsuarios.update(usuarioExistente)) {
