...
public class Usuario implements Registro {
    ...
    public byte[] toByteArray() throws Exception {
        ...
        try {
            ...
            String senhaCriptografada = CriptoRSA.criptografar(this.senha != null ? this.senha : "");
    ...
    public void fromByteArray(byte[] b) throws Exception {
        ...
        try {
            ...
            // Lê a senha criptografada e descriptografa
            String senhaCriptografada = dis.readUTF();
            this.senha = CriptoRSA.descriptografar(senhaCriptografada);
